...
import com.anggie.kotlin.submissions2.util.changeFormatDate
import com.anggie.kotlin.submissions2.util.strToDate
    ...
    private fun getData(){
        ...
        doAsync {
            ...
            uiThread {
                ...
                home_defense.text = if(match.homeLineupDefense.isNullOrEmpty()) "-" else match.homeLineupDefense?.replace("; ", ";\n")
